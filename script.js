...
if(guest) {
    document.getElementById('guest').textContent = "Hello, " + guest + "! You're Invited!";
}
...
// Count down
const targetDate = new Date("2025-12-27T17:00:00").getTime();
...
// audio js
const playerButton = document.querySelector('.music-player'),
